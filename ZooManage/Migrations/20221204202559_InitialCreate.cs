    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AnimalVeterinary", x => new { x.AnimalsId, x.VeterinariesId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_AnimalVeterinary_Veterinaries_VeterinariesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AnimalVeterinary_VeterinariesId",
